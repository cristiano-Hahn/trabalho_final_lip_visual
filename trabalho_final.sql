...
--
-- Host: 127.0.0.1
-- Generation Time: 26-Nov-2018 às 22:28
...
(5, 'Cristiano', 'Rua teste', '097.330.329-80', '1998-01-01'),
(6, 'Joao', 'Teste', '0000000000', '2010-01-01'),
(7, 'Maria', 'Rua de teste', '2381378132', '2010-12-12');
...
--
ALTER TABLE `cidade`
  MODIFY `idcidade` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `veiculo`
  MODIFY `idveiculo` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
